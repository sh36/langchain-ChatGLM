...
llm_model_dict = {
    ...
    # xinghuo
        "xinghuo": {
        "name": "xinghuo",  # "name"修改为fastchat服务中的"model_name"
        "pretrained_model_name": "xinghuo",
        "local_model_path": None,
        "provides": "XINGHUOLLM",  # 使用fastchat api时，需保证"provides"为"FastChatOpenAILLM"
        "api_base_url": "wss://spark-api.xf-yun.com/v1.1/chat"  # "name"修改为fastchat服务中的"api_base_url"
    },

    # minimax
    "fastchat-minimax": {
        "name": "minimax",  # "name"修改为fastchat服务中的"model_name"
        "pretrained_model_name": "minimax",
        "local_model_path": None,
